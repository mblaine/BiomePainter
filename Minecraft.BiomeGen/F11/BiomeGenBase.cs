...
namespace Minecraft.BiomeGen.F11
{
    public class BiomeGenBase
    {
        ...
        public static BiomeGenBase field_46050_r = new BiomeGenBase(16).setTemperatureRainfall(0.8F, 0.4F);
        public static BiomeGenBase field_46049_s = new BiomeGenBase(17).setTemperatureRainfall(2.0F, 0.0F);
        public static BiomeGenBase field_46048_t = new BiomeGenBase(18).setTemperatureRainfall(0.7F, 0.8F);
        public static BiomeGenBase field_46047_u = new BiomeGenBase(19).setTemperatureRainfall(0.05F, 0.8F);
        public static BiomeGenBase field_46046_v = new BiomeGenBase(20).setTemperatureRainfall(0.2F, 0.3F);
